#!/usr/bin/env bash
# Claim 9a exploratory extension: root ordering at lambda^2=250, N=500, HP-1500.
set -euo pipefail
...
echo "=== Claim 9a exploratory: independent root ordering at lambda^2=250, N=500, HP-1500 ==="
